          ...
          function endRound() {
            ...
            */
            ...
            if (liveTeams[demoFile.teams[2].clanName]) {
                liveTeams[demoFile.teams[roundWinner].clanName].score += 1;
                if (roundWinner === 3) {
                  liveTeams[demoFile.teams[2].clanName].scoreAgainst += 1;
                }
                else
                  liveTeams[demoFile.teams[3].clanName].scoreAgainst += 1;
              }
            else {
